...
export function CompetitionsListPage() {
  return (
    <ListPageTemplate<Row>
      ...
      stats={[
        { label: "Active competitions", value: "64", delta: 5.2 },
        { label: "Teams", value: "3,120", delta: 9.8 },
        { label: "Submissions", value: "8,960", delta: 17.3 },
        { label: "Prize pool", value: "$2.4M", hint: "committed this cycle" },
      ]}
      facet={{
        label: "Type",
        key: "type",
        options: ["Hackathon", "Hardware", "Design", "Case Study", "Simulation"],
      }}
