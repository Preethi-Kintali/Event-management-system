  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Button onClick={() => toast.success("Next submission opened")}>
          ...
          <SectionCard title="Scorecard · SUB-2291" description="Weighted criteria out of 100">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap justify-end gap-2">
                <Button variant="outline" onClick={() => toast.success("Draft scorecard saved")}>
                  Save draft
                </Button>
                <Button onClick={() => toast.success("Scorecard submitted")}>
                  Submit scorecard
                </Button>
              </div>
            </div>
