...
export const Route = createFileRoute("/teams/$id")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI for Accessibility Track · 4 members · led by Rhea Kapoor" },
      { property: "og:title", content: "Neural Nomads · Ascent Platform" },
      { property: "og:description", content: "AI for Accessibility Track · 4 members · led by Rhea Kapoor" },
    ],
  }),
...
function TeamDetailsPage() {
  return (
    <DetailsPageTemplate
      ...
      metrics={[{ label: "Progress", value: "82%" }, { label: "Submissions", value: "3" }, { label: "Mentor hours", value: "9.5" }, { label: "Best score", value: "87.5" }]}
      related={[{ id: "r1", label: "SUB-2291", meta: "Submission · In review" }, { id: "r2", label: "Arjun Deshpande", meta: "Mentor · Product Strategy" }, { id: "r3", label: "Hack the Campus", meta: "Event · 22 Aug 2026" }]}
      overview={(
