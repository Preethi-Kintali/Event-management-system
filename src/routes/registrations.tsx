...
const columns: Column<Row>[] = [
  { key: "participant", header: "Participant", sortable: true, render: (row) => <span className="font-medium">{row.participant}</span> },
...
export const Route = createFileRoute("/registrations")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Approve, review and reconcile participant registrations and payments." },
      { property: "og:title", content: "Registrations · Ascent Platform" },
      { property: "og:description", content: "Approve, review and reconcile participant registrations and payments." },
    ],
  }),
  ...
  return (
    <ListPageTemplate<Row>
      ...
      searchKeys={["participant", "email", "event"]}
        stats={[{ label: "Registrations", value: "8,320", delta: 11.5, hint: "this month" }, { label: "Pending approval", value: "24", hint: "SLA 48 hours" }, { label: "Paid conversion", value: "63%", progress: 63 }, { label: "Refunds", value: "$1,240", delta: -6.2 }]}
