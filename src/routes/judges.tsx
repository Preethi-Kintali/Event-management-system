...
const columns: Column<Row>[] = [
  ...
  { key: "completed", header: "Completed", sortable: true },
  {
    ...
    header: "Avg score",
    sortable: true,
    render: (row) => <span className="tabular-nums">{row.avgScore.toFixed(1)}</span>,
  },
  {
    key: "status",
    header: "Status",
...
function JudgesPage() {
  return (
    <ListPageTemplate<Row>
      ...
      stats={[
        { label: "Judges", value: "638", delta: 7.1 },
        { label: "Evaluations done", value: "403", progress: 66 },
        { label: "Avg turnaround", value: "1.8 days", delta: -9.4 },
        { label: "Calibration variance", value: "4.2 pts", hint: "within tolerance" },
      ]}
