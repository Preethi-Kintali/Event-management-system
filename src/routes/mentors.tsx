...
const columns: Column<Row>[] = [
  ...
  { key: "hours", header: "Hours", sortable: true },
  {
    ...
    header: "Rating",
    sortable: true,
    render: (row) => <span className="tabular-nums">{row.rating.toFixed(1)}</span>,
  },
  {
    key: "status",
    header: "Status",
...
export const Route = createFileRoute("/mentors")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Mentor allocation, coaching hours and participant ratings.",
      },
...
function MentorsPage() {
  return (
    <ListPageTemplate<Row>
      ...
      stats={[
        { label: "Mentors", value: "402", delta: 5.5 },
        { label: "Coaching hours", value: "1,860", delta: 12.7 },
        { label: "Avg rating", value: "4.7", hint: "out of 5" },
        { label: "Unassigned", value: "18", hint: "awaiting matching" },
      ]}
