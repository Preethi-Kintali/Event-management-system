...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Organization preferences, branding, security and notification controls.",
      },
...
const toggles = [
  {
    ...
    desc: "Enforce two-factor authentication for privileged roles.",
  },
  {
    id: "t2",
    title: "SSO enforcement",
    desc: "Block password sign-in for members of verified domains.",
  },
...
const channels = [
  {
    ...
    desc: "Email + in-app when a registration needs review.",
  },
      ...
      <Tabs defaultValue="general">
        ...
        <TabsContent value="general" className="mt-4 space-y-6">
          <SectionCard
            ...
            description="Defaults applied to new events"
          >
        ...
        <TabsContent value="branding" className="mt-4 space-y-6">
          <SectionCard
            ...
            description="Applied to certificates and public pages"
          >
                ...
                <div className="flex items-center justify-between rounded-lg border border-border bg-surface/60 p-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Remove platform branding from PDFs.
                    </p>
                  </div>
        ...
        <TabsContent value="security" className="mt-4 space-y-6">
          <Alert>
            ...
            <AlertDescription>
              MFA is enforced for 84% of members. Enable SSO enforcement to reach the enterprise
              baseline.
            </AlertDescription>
          </Alert>
          <SectionCard
            title="Access controls"
            description="Applies to all admin surfaces"
            padded={false}
          >
        ...
        <TabsContent value="notifications" className="mt-4 space-y-6">
          <SectionCard
            ...
            description="Choose what your team receives"
            padded={false}
          >
            <ul className="divide-y divide-border">
              {channels.map((c, i) => (
