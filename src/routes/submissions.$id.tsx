...
export const Route = createFileRoute("/submissions/$id")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Realtime sign language captions · Neural Nomads · Round 2" },
    ],
  }),
...
function SubmissionDetailsPage() {
  return (
    <DetailsPageTemplate
      ...
      crumbs={[{ label: "Programs" }, { label: "Submissions", to: "/submissions" }, { label: "Submission details" }]}
      ...
      metrics={[{ label: "Score", value: "87.5", caption: "weighted average" }, { label: "Reviewers", value: "2 of 3" }, { label: "Plagiarism", value: "0 flags" }, { label: "Round", value: "Round 2" }]}
      related={[{ id: "r1", label: "Neural Nomads", meta: "Team · 4 members" }, { id: "r2", label: "AI for Accessibility Track", meta: "Competition" }, { id: "r3", label: "Dr. Elena Marković", meta: "Reviewer · scored 88" }]}
      overview={(
            ...
            {scorecardCriteria.map((c) => (
              <li key={c.id} className="px-5 py-4">
                <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3">
                  ...
                  <span className="shrink-0 text-sm tabular-nums">{c.score} / {c.weight}</span>
                </div>
