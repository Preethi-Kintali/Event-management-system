...
const columns: Column<Row>[] = [
  ...
  { key: "score", header: "Score", sortable: true, render: (row) => <span className="tabular-nums">{row.score ? row.score.toFixed(1) : "—"}</span> },
...
export const Route = createFileRoute("/submissions/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Every submission with round, score and reviewer coverage." },
    ],
  }),
  ...
  return (
    <ListPageTemplate<Row>
      ...
      searchKeys={["title", "team", "competition"]}
        stats={[{ label: "Submissions", value: "8,960", delta: 17.3 }, { label: "Awaiting review", value: "88", hint: "Round 2 closes soon" }, { label: "Avg score", value: "76.4", delta: 1.8 }, { label: "Reviewer coverage", value: "92%", progress: 92 }]}
