...
export const Route = createFileRoute("/volunteers")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Shift planning and on-ground volunteer coverage per event.",
      },
...
function VolunteersPage() {
  return (
    <ListPageTemplate<Row>
      ...
      stats={[
        { label: "Volunteers", value: "294", delta: 3.4 },
        { label: "Shifts filled", value: "88%", progress: 88 },
        { label: "Hours logged", value: "3,420", delta: 8.1 },
        { label: "Open shifts", value: "26", hint: "next 7 days" },
      ]}
